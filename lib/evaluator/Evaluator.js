...
Evaluator.prototype.eval = function(ast) {
	return Promise.resolve().then(this.evalLazy.bind(this, ast))
};
...
MetaEvaluator.prototype.eval = function(obj) {
	var result = (obj instanceof Flood || Array.isArray(obj))
		? this.evalFlood(Flood.from(obj))
		: this.evalOne(obj);
	return this._consume ? utils.consume(result) : Flood.from(result);
};

MetaEvaluator.prototype.evalFlood = function(flood) {
	return flood.map(this.evalOne.bind(this));
};
